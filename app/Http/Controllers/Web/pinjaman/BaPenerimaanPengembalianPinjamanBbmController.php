...
class BaPenerimaanPengembalianPinjamanBbmController extends Controller
{
                ...
                if ($baPengembalian) {
                    return response()->json([
                        ...
                        'data' => [
                            ...
                            'volume_sebelum' => $baPengembalian->volume_sebelum,
    ...
    public function store(Request $request)
    {
        $validator = Validator::make($request->all(), [
            ...
            'trans_id' => 'required|exists:bbm_kapaltrans,trans_id',
        ...
        try {
            ...
            $baPengembalian = BbmKapaltrans::find($request->trans_id);
            ...
            $ba = BbmKapaltrans::create([
                ...
                'an_nakhoda_temp' => $baPengembalian->an_nakhoda_temp,
                'an_kkm_temp' => $baPengembalian->an_kkm_temp,
                'link_modul_temp' => $baPengembalian->link_ba,
    ...
    public function show(BbmKapaltrans $baPenerimaanPengembalian)
    {
        ...
        if ($baPengembalian) {
            $data->trans_id = $baPengembalian->trans_id;
        ...
        if ($baPengembalian) {
            $responseData['trans_id'] = $baPengembalian->trans_id;
    ...
    public function update(Request $request, BbmKapaltrans $baPenerimaanPengembalian)
    {
        ...
        try {
            ...
            if ($request->trans_id) {
                ...
                $baPengembalian = BbmKapaltrans::where('nomor_surat', $request->link_modul_temp)->first();
            }
            if (!$baPengembalian) {
                return response()->json([
                    'success' => false,
