...
class BaPenitipanBbmController extends Controller
{
    ...
    public function getData(Request $request)
    {
        $query = BbmKapaltrans::with(['kapal'])
            ->where('status_ba', 5); // BA Penitipan BBM (sesuai project_ci)
    ...
    public function getBaData(Request $request)
    {
        ...
        try {
            ...
            // Cek apakah sudah ada BA Penitipan BBM untuk tanggal dan kapal ini
            ...
            if ($existingBa) {
                return response()->json([
                    'success' => false,
                    'message' => 'BA Penitipan Bbm untuk kapal dan tanggal ini sudah ada'
                ], 400);
            }
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            $ba = BbmKapaltrans::create([
                ...
                'status_ba' => 5, // BA Penitipan BBM (sesuai project_ci)
    ...
    {
        try {
            $baPenitipanBbm = BbmKapaltrans::where('status_ba', 5)
    ...
    public function update(Request $request, $id)
    {
        ...
        try {
            ...
            // Update volume_pengisian di tabel utama
            $baPenitipanBbm->update(['volume_pengisian' => $totalVolume]);
    ...
    public function destroy($id)
    {
        try {
            // Find the record first
            $baPenitipanBbm = BbmKapaltrans::where('status_ba', 5)->find($id);
            ...
            $hasPayment = BbmTransdetail::hasPayment($baPenitipanBbm->nomor_surat);
            ...
            BbmTransdetail::where('nomor_surat', $baPenitipanBbm->nomor_surat)->delete();
    ...
    public function generatePdf($id)
    {
        try {
            ...
            $baPenitipanBbm->load(['kapal.upt', 'transdetails']);
            ...
            $html .= '<br><br>
                <table cellpadding="0" cellspacing="0" width="100%" style="font-family: Arial, Helvetica, sans-serif;font-size:' . $fontSize . '" border="0">
                    <tr>
                        <td width="100%" align="justify">Demikian Berita Acara Penitipan BBM ini dibuat dengan sebenar – benarnya untuk dapat dipergunakan sebagaimana mestinya.
                        </td>
                    </tr>
                </table>';
