...
class BaSebelumPengisianController extends Controller
{
     ...
     */
    public function show(BbmKapaltrans $baSebelumPengisian)
    {
        return response()->json([
            'success' => true,
            'data' => $baSebelumPengisian->load('kapal')
        ]);
    }
     ...
     */
    public function update(Request $request, BbmKapaltrans $baSebelumPengisian)
    {
        $validator = Validator::make($request->all(), [
            'kapal_id' => 'required|exists:m_kapal,m_kapal_id',
            'nomor_surat' => 'required|string|max:50|unique:bbm_kapaltrans,nomor_surat,' . $baSebelumPengisian->trans_id . ',trans_id',
            'tanggal_surat' => 'required|date',
            'jam_surat' => 'required|date_format:H:i',
            'zona_waktu_surat' => 'required|in:WIB,WITA,WIT',
            'lokasi_surat' => 'required|string', // TEXT field, no max limit
     ...
     */
    public function destroy(BbmKapaltrans $baSebelumPengisian)
    {
        try {
     ...
     */
    public function generatePdf(BbmKapaltrans $baSebelumPengisian)
    {
        try {
