...
class BaPengembalianBbmController extends Controller
{
    ...
    public function getData(Request $request)
    {
        $query = BbmKapaltrans::with(['kapal'])
            ->where('status_ba', 5); // BA Pengembalian BBM (sesuai project_ci)
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            $ba = BbmKapaltrans::create([
                ...
                'status_ba' => 5, // BA Pengembalian BBM (sesuai project_ci)
    ...
    {
        try {
            $baPengembalianBbm = BbmKapaltrans::where('status_ba', 5)
    ...
    public function update(Request $request, $id)
    {
        ...
        try {
            ...
            // Update volume_pengisian di tabel utama
            $baPengembalianBbm->update(['volume_pengisian' => $totalVolume]);
    ...
    public function destroy($id)
    {
        try {
            // Find the record first
            $baPengembalianBbm = BbmKapaltrans::where('status_ba', 5)->find($id);
            ...
            $hasPayment = BbmTransdetail::hasPayment($baPengembalianBbm->nomor_surat);
            ...
            BbmTransdetail::where('nomor_surat', $baPengembalianBbm->nomor_surat)->delete();
    ...
    public function generatePdf($id)
    {
        try {
            ...
            $baPengembalianBbm->load(['kapal.upt', 'transdetails']);
