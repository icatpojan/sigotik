...
class Ba_penerima_hibah_kapal_pengawas extends CI_Controller {
	...
	public function getDataTable(){
		...
		$sql = "SELECT * 
					FROM bbm_kapaltrans a WHERE status_ba = 15
	...
	function getDataEdit($trans_id){
		...
		$ed .= '
				 ...
				 <div class="col-md-6">
					<div class="form-group">
						...
						<select class="form-control custom-control" id="m_kapal_id" name="m_kapal_id"> ';
								...
								$sql7 = "SELECT * FROM m_kapal WHERE code_kapal = '".$list->kapal_code."' "; 
			...
			<div class="row">
				...
				<div class="col-md-3">
					<div class="form-group">
						<label>No BA Pemberi HIBAH</label>
						<select class="form-control custom-control" id="link_modulTemp" name="link_modulTemp">';
							
								
							$sql3 = "SELECT trans_id, nomor_surat FROM bbm_kapaltrans WHERE nomor_surat = '".$list->link_modul_ba."'";
						
									
							$query3 = $ci->db->query($sql3);
							foreach ($query3->result() as $list3){
								$ed .=  '<option value="'.$list3->trans_id.'">'.$list3->nomor_surat.'</option>';
							}
				...
				<div class="col-md-3 ">
					...
					<input type="text" name="tanggal_hibah" id="tanggal_hibah" class="form-control datepicker" value="'.date("d-m-Y", strtotime($list2->tanggal_surat)).'" disabled>
				 </div>
				
				<div class="col-md-3 ">
					<div class="form-group">
						<label>KODE KAPAL Pemberi HIBAH</label>
			...
			<div class="row">
				...
				<div class="col-md-4">
				 ...
				 <div class="col-md-5">
					...
					<input type="text" name="volume_pengisian" id="volume_pengisian" class="form-control angka" value="'.number_format($list->volume_pengisian).'" readonly="">
				 </div>
			...
			<br>
				 <div class="col-md-4 ">
					<label>NAMA NAKHODA Pemberi Hibah &nbsp;&nbsp;| &nbsp;&nbsp;<input type="checkbox" class="custom-control-input" id="an_nakhoda_temp" name="an_nakhoda_temp" value="1" '.$an_nakhoda_temp.' > An.  </label>
			...
			<br>
				 <div class="col-md-4 ">
					<label>NAMA KKM Pemberi Hibah &nbsp;&nbsp;| &nbsp;&nbsp;<input type="checkbox" class="custom-control-input" id="an_kkm_temp" name="an_kkm_temp" value="1" '.$an_kkm_temp.' > An. </label>
		...
		$ed .= '
			...
			<div class="row">
				...
				<div class="col-md-3">
					<div class="form-group">
						<label>No BA Pemberi HIBAH</label>
						<select class="form-control custom-control" id="link_modulTemp" name="link_modulTemp" disabled>';
