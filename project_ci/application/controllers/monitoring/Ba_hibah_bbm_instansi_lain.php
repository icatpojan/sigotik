...
class Ba_hibah_bbm_instansi_lain extends CI_Controller {
	...
	public function getDataTable(){
		...
		$sql = "SELECT * 
					FROM bbm_kapaltrans a WHERE status_ba = 16
	...
	function getDataEdit($trans_id){
		...
		$ed .= '
			...
			<div class="row">
				...
				<div class="col-md-4 ">
					<div class="form-group">
						<label>Nama Kapal Penerima Hibah</label>
			...
			<div class="row">
				...
				<div class="col-md-4">
				 ...
				 <div class="col-md-5">
					...
					<input type="text" name="volume_pemakaianEd" id="volume_pemakaianEd" class="form-control angka" onkeypress="validate(event)" onChange="validateVolume(1)" value="'.number_format($list->volume_pemakaian).'" >
				 </div>
		...
		$ed .= '
			...
			<div class="row">
				...
				<div class="col-md-4 ">
					<div class="form-group">
						<label>Nama Kapal Penerima Hibah</label>
						<input type="text" name="kapal_code_temp" id="kapal_code_temp" class="form-control" value="'.$list->kapal_code_temp.'" readonly="">
					</div>
				</div>
