...
<div class="row">
    <ul id="tabs">
      ...
      <li><a id="tab1" onClick="getTab1()">Laporan Verifikasi Realisasi Per UPT</a></li>
...
function preview(){
			...
			$('#isiData').load('<?php echo base_url()?>index.php/lap/lap/showdlapverifikasi/'+tgl_awal+'/'+tgl_akhir+'/'+code+'/'+code2);
		}
...
function toprint(){
	...
	var xx = '<?php echo base_url()?>'+'index.php/lap/lap_cetak/showdlapverifikasi/'+tgl_awal+'/'+tgl_akhir+'/'+code+'/'+code2;
...
function toexcel(){
	...
	var xx = '<?php echo base_url()?>'+'index.php/lap/lap_excel/showdlapverifikasi/'+tgl_awal+'/'+tgl_akhir+'/'+code+'/'+code2;
	var x = window.open(xx,'_blank');
    x.focus();
}
