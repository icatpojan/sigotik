...
<div class="row">
    <ul id="tabs">
      ...
      <li><a id="tab1" onClick="getTab1()">Laporan Pengembalian BBM</a></li>
...
function preview(){
	...
	$('#isiData').load('<?php echo base_url()?>index.php/lap/lap/showpengembalianbbm/'+tgl_awal+'/'+tgl_akhir+"/"+m_kapal_id);
}
...
function toprint(){
	...
	var xx = '<?php echo base_url()?>'+'index.php/lap/lap_cetak/showpengembalianbbm/'+tgl_awal+'/'+tgl_akhir+"/"+m_kapal_id;
...
function toexcel(){
	...
	var xx = '<?php echo base_url()?>'+'index.php/lap/lap_excel/showpengembalianbbm/'+tgl_awal+'/'+tgl_akhir+"/"+m_kapal_id;
	var x = window.open(xx,'_blank');
    x.focus();
}
