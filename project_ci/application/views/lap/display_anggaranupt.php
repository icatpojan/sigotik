...
<div class="row">
    <ul id="tabs">
      ...
      <li><a id="tab1" onClick="getTab1()">Monitoring Penggunaan BBM Per UPT</a></li>
...
function preview(){
	...
	$('#isiData').load('<?php echo base_url()?>index.php/lap/lap/showPenggunaanUPT/'+tgl_awal+'/'+tgl_akhir+'/'+code);
}
...
function toprint(){
	...
	var xx = '<?php echo base_url()?>'+'index.php/lap/lap_cetak/showPenggunaanUPT/'+tgl_awal+'/'+tgl_akhir+'/'+code;
...
function toexcel(){
	...
	var xx = '<?php echo base_url()?>'+'index.php/lap/lap_excel/showPenggunaanUPT/'+tgl_awal+'/'+tgl_akhir+'/'+code;
	var x = window.open(xx,'_blank');
    x.focus();
}		
</script>