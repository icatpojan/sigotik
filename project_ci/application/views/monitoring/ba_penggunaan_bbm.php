...
<div class="row">
	...
	<ul id="tabs">
      ...
      <li><a id="tab4">Form <?php echo $menu1?></a></li>
	...
	<div class="container" id="tab2C">
		<form id="dataSeri">
			...
			<div class="row">
				...
				<div class="col-md-3 ">
					<label>TANGGAL</label>
					<input type="text" name="tanggal_surat" id="tanggal_surat" class="form-control datepicker" onChange="getValBa()" >
				 </div>
			...
			<div class="row">
				...
				<div class="col-md-6 ">
					<div class="form-group">
						<label>VOLUME TANGKI PENGUKURAN SEBELUMNYA </label>
						 <input type="text" placeholder="" id="volume_sebelum" name="volume_sebelum" class="form-control angka" value="0" onkeypress="validate(event)" onkeyup="getPenggunaan()" >
					</div>
				</div>
				...
				<div class="col-md-4 ">
					<div class="form-group">
						...
						<input type="text" placeholder="" id="tanggal_sebelum" name="tanggal_sebelum" class="form-control datepicker" value="" >
					</div>
				</div>
				...
				<div class="col-md-6 ">
					<div class="form-group">
						<label>VOLUME PENGISIAN SEBELUMNYA</label>
						  <input type="text" placeholder="" id="volume_pengisian" name="volume_pengisian" class="form-control angka" value="0" onkeypress="validate(event)" onkeyup="getPenggunaan()">
					</div>
				</div>
				...
				<div class="col-md-4 ">
					<div class="form-group">
						<label>TANGGAL PENGISIAN SEBELUMNYA</label>
						   <input type="text" placeholder="" id="tanggal_pengisian" name="tanggal_pengisian" class="form-control datepicker" value="">
					</div>
				</div>
				...
				<div class="col-md-5 ">
					<div class="form-group">
						<label>VOLUME TANGKI BBM PENGUKURAN SAAT INI</label>
						   <input type="text" placeholder="" id="volume_pemakaian" name="volume_pemakaian" class="form-control angka" value="0" onkeypress="validate(event)" onkeyup="getPenggunaan()" readonly>
					</div>
				</div>
				...
				<div class="col-md-5 ">
					<div class="form-group">
						<label>JUMLAH PENGGUNAAN</label>
						   <input type="text" placeholder="" id="volume_sisa" name="volume_sisa" class="form-control angka" value="0" >
					</div>
				</div>
			</div>
			...
			<div class="row">
				...
				<div class="col-md-5 ">
    				<div class="form-group">
    						...
    						<input type="text" name="peruntukan" name="peruntukan" class="form-control" value="">
    					</div>
    				</div>
			</div>
			...
			<div class="row">
				...
				<div class="col-md-4">
					<label></label>
						<button type="button" class="btn btn-warning" id="createdok" onClick="createDok()">Buat Dokumen</button>
				 </div>
			</div>			
		</form>
	</div>     
...
$(document).ready(function() {
	...
	$('#data_tables').dataTable({
		...
		'sAjaxSource'    : '<?php echo base_url()?>index.php/monitoring/ba_penggunaan_bbm/getDataTable',
...
function getTab3(trans_id){
	// alert(nomor_surat);
	$('#tab3').show();
	$('#dataUlang').load('<?php echo base_url()?>index.php/monitoring/ba_penggunaan_bbm/getDataUpload/'+trans_id);
	$('#tab3').click();
}

function getTab4(trans_id){
	$('#tab4').show();
	$('#dataRubah').load('<?php echo base_url()?>index.php/monitoring/ba_penggunaan_bbm/getDataEdit/'+trans_id);
	$('#tab4').click();
}

function getTab5(trans_id){
	$('#tab5').show();
	$('#dataLihat').load('<?php echo base_url()?>index.php/monitoring/ba_penggunaan_bbm/getDataLihat/'+trans_id);
	$('#tab5').click();
}
...
function getValBa(){
    ...
    $.ajax({
		type : "POST",
		url	: "<?php echo base_url()?>index.php/monitoring/ba_penggunaan_bbm/getDataBa",
		data: dataForm,
		dataType: "json",
		success: function (data) {
...
function createDok(){
    ...
    $("#tanggal_sebelum").removeAttr("disabled");
	...
	if(nomor_surat == ''){
	    ...
	    $.ajax({
    		type : 'POST',
    		url: '<?php echo WS_JQGRID."monitoring.ba_penggunaan_bbm/create"; ?>',
    		data : x,
    		dataType : 'json',
    		success : function(data){
...
function editDok(){
	...
	$.ajax({
		type : 'POST',
		url: '<?php echo WS_JQGRID."monitoring.ba_penggunaan_bbm/edit"; ?>',
		data : x,
		dataType : 'json',
		success : function(data){
...
function getPenggunaan(){
	...
	var res = 0;
	document.getElementById('volume_sisa').value = res;
	
	document.getElementById('volume_sisa').value = ReplaceNumberWithCommas(parseFloat(document.getElementById('volume_sebelum').value.replace(/,/g ,''))+parseFloat(document.getElementById('volume_pengisian').value.replace(/,/g ,'')) - parseFloat(document.getElementById('volume_pemakaian').value.replace(/,/g ,'')));
	
}

function getPenggunaanx(){
	
	document.getElementById('volume_sisax').value = ReplaceNumberWithCommas(parseFloat(document.getElementById('volume_sebelumx').value.replace(/,/g ,''))+parseFloat(document.getElementById('volume_pengisianx').value.replace(/,/g ,'')) - parseFloat(document.getElementById('volume_pemakaianx').value.replace(/,/g ,'')));
