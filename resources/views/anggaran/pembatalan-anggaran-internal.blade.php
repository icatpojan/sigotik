...
<div class="space-y-6">
    ...
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
            ...
            <p class="text-gray-600 dark:text-gray-400">Batalkan anggaran internal yang telah disetujui</p>
        </div>
    </div>
...
<script>
    ...
    function viewAnggaran(periode) {
        ...
        $.get('{{ route("anggaran.pembatalan-anggaran-internal.view", [":periode"]) }}'.replace(':periode', periode), function(data) {
    ...
    function cancelAnggaran(periode) {
        if (confirm('Apakah Anda yakin ingin membatalkan anggaran internal periode ' + periode + '?')) {
            $.ajax({
                ...
                , success: function(response) {
                    if (response.success) {
                        toastr.success('Anggaran internal berhasil dibatalkan');
                        loadData();
                    } else {
