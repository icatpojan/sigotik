...
<script>
    ...
    $(document).ready(function() {
        ...
        $('#kapal_id').change(function() {
            ...
            if (kapalId) {
                ...
                $.ajax({
                    url: '/ba-sebelum-pelayaran/kapal-data'
                    , type: 'GET'
                    , data: {
                        kapal_id: kapalId
                    }
        ...
        $('#baForm').on('submit', function(e) {
            ...
            const baId = $('#baId').val();
            const url = baId ? `/ba-sebelum-pelayaran/${baId}` : '/ba-sebelum-pelayaran';
    ...
    function editBa(baId) {
        $.ajax({
            ...
            , success: function(response) {
                if (response.success) {
                    const ba = response.data;
                    $('#modalTitle').text('Form Edit BA Sebelum Pelayaran');
    ...
    function generatePdf(baId) {
        ...
        $.ajax({
            url: `/ba-sebelum-pelayaran/${baId}/pdf`
            , type: 'GET'
    ...
    function viewDocument(baId) {
        ...
        $.ajax({
            url: `/ba-sebelum-pelayaran/${baId}/view-document`
            , type: 'GET'
            , success: function(response) {
                if (response.success) {
                    $('#documentViewer').html(`
                        <div class="text-center">
                            <div class="mb-4">
                                ...
                                <p class="text-sm text-gray-600 dark:text-gray-400">Dokumen pendukung BA Sebelum Pelayaran</p>
                            </div>
    ...
    $(document).ready(function() {
        $('#uploadForm').on('submit', function(e) {
            ...
            $.ajax({
                url: `/ba-sebelum-pelayaran/${currentBaId}/upload`
                , type: 'POST'
                , data: formData
                , processData: false
                , contentType: false
        ...
        $('#deleteDocumentBtn').on('click', function() {
            ...
            if (confirm('Apakah Anda yakin ingin menghapus dokumen ini?')) {
                ...
                $.ajax({
                    url: `/ba-sebelum-pelayaran/${currentBaId}/delete-document`
                    , type: 'DELETE'
                    , data: {
                        _token: $('meta[name="csrf-token"]').attr('content')
                    }
        ...
        <div class="relative mx-auto p-6 border w-11/12 md:w-4/5 lg:w-3/4 xl:w-2/3 shadow-lg rounded-lg bg-white dark:bg-gray-800 max-h-[95vh] overflow-y-auto">
            <div class="mt-3">
                <div class="flex items-center justify-between pb-6 border-b border-gray-200 dark:border-gray-700">
                    <div>
                        <h3 id="modalTitle" class="text-xl font-semibold text-gray-900 dark:text-white">Form Tambah BA Sebelum Pelayaran</h3>
                        <p class="text-sm text-gray-600 dark:text-gray-400 mt-1">Lengkapi data berikut untuk membuat Berita Acara Sebelum Pelayaran</p>
                    </div>
                    ...
                    <div class="bg-yellow-50 dark:bg-yellow-900/20 rounded-lg p-4">
                        ...
                        <div>
                            <label for="volume_sisa" class="block text-sm font-semibold text-gray-700 dark:text-gray-300 mb-2">
                                Sisa BBM Sebelum Pelayaran (Liter) <span class="text-red-500">*</span>
                            </label>
                            <div class="relative">
    ...
    <div class="flex items-center justify-center min-h-full py-8">
        <div class="relative mx-auto p-6 border w-11/12 md:w-3/4 lg:w-2/3 shadow-lg rounded-lg bg-white dark:bg-gray-800 max-h-[90vh] overflow-y-auto">
            <div class="mt-3">
                <div class="flex items-center justify-between pb-6 border-b border-gray-200 dark:border-gray-700">
                    <div>
                        <h3 class="text-xl font-semibold text-gray-900 dark:text-white">Detail BA Sebelum Pelayaran</h3>
                        <p class="text-sm text-gray-600 dark:text-gray-400 mt-1">Informasi lengkap Berita Acara Sebelum Pelayaran</p>
                    </div>
