...
<head>
    ...
    <title>Login | Sigotik - Sistem Manajemen BBM Kapal</title>
...
<body x-data="{ page: 'comingSoon', 'loaded': true, 'darkMode': false, 'stickyMenu': false, 'sidebarToggle': false, 'scrollTop': false }" x-init="
    ...
    <div x-show="!loaded" class="fixed inset-0 z-50 flex items-center justify-center bg-white dark:bg-gray-900">
        <div class="animate-spin rounded-full h-32 w-32 border-b-2 border-brand-500"></div>
    </div>
    <!-- ===== Preloader End ===== -->
    ...
    <div class="relative p-6 bg-white z-1 dark:bg-gray-900 sm:p-0">
        <div class="relative flex flex-col justify-center w-full h-screen dark:bg-gray-900 sm:p-0 lg:flex-row">
                                ...
                                <div class="space-y-5">
                                    ...
                                    <div>
                                        ...
                                        <div x-data="{ showPassword: false }" class="relative">
                                            <input :type="showPassword ? 'text' : 'password'" id="password" name="password" placeholder="Masukkan password" class="dark:bg-dark-900 h-11 w-full rounded-lg border @error('password') border-red-500 @else border-gray-300 @enderror bg-transparent py-2.5 pl-4 pr-11 text-sm text-gray-800 shadow-theme-xs placeholder:text-gray-400 focus:border-brand-300 focus:outline-hidden focus:ring-3 focus:ring-brand-500/10 dark:border-gray-700 dark:bg-gray-900 dark:text-white/90 dark:placeholder:text-white/30 dark:focus:border-brand-800" required />
            ...
            {{-- <div class="relative items-center hidden w-full h-full lg:grid lg:w-1/2" style="background-color: #568fd2;"> --}}
            <div class="relative items-center hidden w-full h-full lg:grid lg:w-1/2" style="background-color: #465fff;">
                <div class="flex items-center justify-center z-1">
                    <!-- Background dengan warna solid -->
                    <div class="flex flex-col items-center max-w-xs">
                        <div class="block mb-4">
                            <img src="{{ asset('images/logo-kkp.png') }}" alt="Logo KKP" class="h-20 w-auto">
                        </div>
                        <h2 class="text-2xl font-bold text-white mb-2">Sigotik</h2>
