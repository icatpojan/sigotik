...
<div class="container-fluid">
    ...
    <div class="d-flex justify-content-between align-items-center mb-6">
        <div>
            ...
            <p class="text-sm text-gray-600 dark:text-gray-400 mt-1">Laporan Total Anggaran BBM</p>
        </div>
    </div>
...
<script>
    $(document).ready(function() {
        ...
        $('#printBtn').click(function() {
            ...
            form.method = 'POST';
            form.action = '{{ route("laporan-anggaran.export.pdf", "anggaran") }}';
            form.target = '_blank';
        ...
        $('#excelBtn').click(function() {
            ...
            const form = document.createElement('form');
            form.method = 'POST';
            form.action = '{{ route("laporan-anggaran.export.excel", "anggaran") }}';
            form.target = '_blank';
        ...
        `);
            ...
            $.get('{{ route("laporan-anggaran.anggaran.data") }}', {
                periode: periode
            }, function(data) {
