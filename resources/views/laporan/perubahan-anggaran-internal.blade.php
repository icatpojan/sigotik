...
@section('title', 'Laporan Transaksi Perubahan Anggaran Internal UPT')
...
<div class="container-fluid">
    ...
    <div class="d-flex justify-content-between align-items-center mb-6">
        <div>
            <h1 class="text-2xl font-bold text-gray-900 dark:text-white">Laporan Transaksi Perubahan Anggaran Internal UPT</h1>
            <p class="text-sm text-gray-600 dark:text-gray-400 mt-1">Laporan Transaksi Perubahan Anggaran UPT</p>
        </div>
    </div>
