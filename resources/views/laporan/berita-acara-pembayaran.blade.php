...
@section('title', 'Laporan Berita Acara Pembayaran Tagihan')
...
<div class="container-fluid">
    ...
    <div class="d-flex justify-content-between align-items-center mb-6">
        <div>
            <h1 class="text-2xl font-bold text-gray-900 dark:text-white">Laporan Berita Acara Pembayaran Tagihan</h1>
            <p class="text-sm text-gray-600 dark:text-gray-400 mt-1">Berita Acara Pembayaran Tagihan</p>
        </div>
    </div>
...
<script>
    $(document).ready(function() {
        ...
        function loadUptOptions() {
            $.get('{{ route("laporan-anggaran.berita-acara-pembayaran.upts") }}', function(data) {
        ...
        `);
            ...
            $.get('{{ route("laporan-anggaran.berita-acara-pembayaran.data") }}', {
                tgl_awal: tglAwal
                , tgl_akhir: tglAkhir
                , upt_code: uptCode
            }, function(data) {
