...
@section('title', 'LAP Total Penerimaan & Penggunaan BBM')
...
<div class="space-y-6">
    ...
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
            <h1 class="text-2xl font-bold text-gray-900 dark:text-white">LAP Total Penerimaan & Penggunaan BBM</h1>
            <p class="text-gray-600 dark:text-gray-400">Laporan total penerimaan dan penggunaan BBM</p>
        </div>
    </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
            <div class="bg-blue-50 dark:bg-blue-900/30 border border-blue-200 dark:border-blue-700 rounded-lg p-4">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        <h3 class="text-sm font-medium text-blue-800 dark:text-blue-200">Total Penerimaan</h3>
                        <p id="total-penerimaan" class="text-2xl font-bold text-blue-900 dark:text-blue-100">0 Liter</p>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-green-50 dark:bg-green-900/30 border border-green-200 dark:border-green-700 rounded-lg p-4">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        <h3 class="text-sm font-medium text-green-800 dark:text-green-200">Total Penggunaan</h3>
                        <p id="total-penggunaan" class="text-2xl font-bold text-green-900 dark:text-green-100">0 Liter</p>
                    </div>
                </div>
            </div>
        </div>
...
<script>
    ...
    function loadData() {
        ...
        $.ajax({
            url: '{{ route("laporan-bbm.total-penerimaan-penggunaan.data") }}'
            , method: 'GET'
            , data: {
            ...
            , success: function(response) {
                ...
                $('#total-penerimaan').text(response.total_penerimaan + ' Liter');
                $('#total-penggunaan').text(response.total_penggunaan + ' Liter');
            ...
            , error: function(xhr, status, error) {
                ...
                $('#dataTable').html(`
                <tr>
                    <td colspan="7" class="px-6 py-4 text-center text-red-500 border border-gray-300 dark:border-gray-600">
                        <div class="flex flex-col items-center py-8">
    ...
    function exportData(format = 'excel') {
        ...
        fetch(`{{ route("laporan-bbm.total-penerimaan-penggunaan.export") }}?${params}`)
            .then(response => {
                if (response.ok) {
