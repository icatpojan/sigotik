...
@section('title', 'Laporan BBM Akhir Bulan')
...
<div class="space-y-6">
    ...
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
            <h1 class="text-2xl font-bold text-gray-900 dark:text-white">Laporan BBM Akhir Bulan</h1>
            <p class="text-gray-600 dark:text-gray-400">Laporan BBM untuk periode akhir bulan</p>
        </div>
    </div>
        ...
        <div class="border-b border-gray-200 dark:border-gray-700 mb-4 pb-4">
            <form id="filterForm" class="flex flex-col sm:flex-row gap-4 items-end">
                ...
                <div class="w-full sm:w-40">
                    ...
                    <select id="bulan" name="bulan" class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:text-white">
                ...
                <div class="w-full sm:w-40">
                    ...
                    <select id="tahun" name="tahun" class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:text-white">
            ...
            <table class="min-w-full border-collapse border border-gray-300 dark:border-gray-600">
                <thead style="background-color: #568fd2;">
                    <tr>
                        ...
                        <th class="px-6 py-3 text-center text-xs font-medium text-white uppercase tracking-wider border border-gray-300 dark:border-gray-600">Tanggal</th>
                        ...
                        <th class="px-6 py-3 text-center text-xs font-medium text-white uppercase tracking-wider border border-gray-300 dark:border-gray-600">Status BA</th>
...
<script>
    ...
    function loadData() {
        ...
        $.ajax({
            url: '{{ route("laporan-bbm.akhir-bulan.data") }}'
            , method: 'GET'
            , data: {
                bulan: bulan
                , tahun: tahun
    ...
    function exportData(format = 'excel') {
        ...
        fetch(`{{ route("laporan-bbm.akhir-bulan.export") }}?${params}`)
            .then(response => {
                if (response.ok) {
