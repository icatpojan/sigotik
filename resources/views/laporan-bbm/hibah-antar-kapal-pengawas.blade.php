...
@section('title', 'Laporan Hibah Antar Kapal Pengawas')
...
<div class="space-y-6">
    ...
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
            <h1 class="text-2xl font-bold text-gray-900 dark:text-white">Laporan Hibah Antar Kapal Pengawas</h1>
            <p class="text-gray-600 dark:text-gray-400">Laporan hibah BBM antar kapal pengawas</p>
        </div>
    </div>
...
<script>
    ...
    function loadData() {
        ...
        $.ajax({
            url: '{{ route("laporan-bbm.hibah-antar-kapal-pengawas.data") }}'
            , method: 'GET'
            , data: {
        ...
        fetch(`{{ route("laporan-bbm.hibah-antar-kapal-pengawas.export") }}?${params}`)
            .then(response => {
                if (response.ok) {
