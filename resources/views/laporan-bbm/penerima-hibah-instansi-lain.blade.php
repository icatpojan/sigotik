...
@section('title', 'Laporan Penerima Hibah BBM Instansi Lain')
...
<div class="space-y-6">
    ...
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
            <h1 class="text-2xl font-bold text-gray-900 dark:text-white">Laporan Penerima Hibah BBM Instansi Lain</h1>
            <p class="text-gray-600 dark:text-gray-400">Laporan penerima hibah BBM dari instansi lain</p>
        </div>
    </div>
...
<script>
    ...
    function loadData() {
        ...
        $.ajax({
            url: '{{ route("laporan-bbm.penerima-hibah-instansi-lain.data") }}'
            , method: 'GET'
            , data: {
                        ...
                        <tr class="hover:bg-gray-50 dark:hover:bg-gray-700">
                            ...
                            <td class="px-6 py-4 text-center border border-gray-300 dark:border-gray-600">
                                <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-green-100 text-green-800 dark:bg-green-900/30 dark:text-green-400">
                                    BA Penerima Hibah BBM Instansi Lain
                                </span>
                            </td>
                            <td class="px-6 py-4 border border-gray-300 dark:border-gray-600">
    ...
    function exportData(format = 'excel') {
        ...
        fetch(`{{ route("laporan-bbm.penerima-hibah-instansi-lain.export") }}?${params}`)
            .then(response => {
                if (response.ok) {
            ...
            .then(blob => {
                ...
                a.href = url;
                a.download = `laporan_penerima_hibah_instansi_lain_${format}_${new Date().toISOString().split('T')[0]}.${format === 'excel' ? 'xlsx' : 'pdf'}`;
