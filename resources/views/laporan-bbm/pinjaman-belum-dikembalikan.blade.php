...
@section('title', 'Laporan Pinjaman Belum di Kembalikan')
...
<div class="space-y-6">
    ...
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
            <h1 class="text-2xl font-bold text-gray-900 dark:text-white">Laporan Pinjaman Belum di Kembalikan</h1>
            <p class="text-gray-600 dark:text-gray-400">Laporan pinjaman BBM yang belum dikembalikan</p>
        </div>
    </div>
            ...
            <table class="min-w-full border-collapse border border-gray-300 dark:border-gray-600">
                <thead style="background-color: #568fd2;">
                    <tr>
                        ...
                        <th class="px-6 py-3 text-center text-xs font-medium text-white uppercase tracking-wider border border-gray-300 dark:border-gray-600">Tanggal Peminjaman</th>
...
<script>
    ...
    function loadData() {
        ...
        $.ajax({
            url: '{{ route("laporan-bbm.pinjaman-belum-dikembalikan.data") }}'
            , method: 'GET'
            , data: {
                upt_id: uptId
                , kapal_id: kapalId
    ...
    function exportData(format = 'excel') {
        ...
        fetch(`{{ route("laporan-bbm.pinjaman-belum-dikembalikan.export") }}?${params}`)
            .then(response => {
                if (response.ok) {
