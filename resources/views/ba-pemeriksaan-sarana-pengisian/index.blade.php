...
<!-- Modal Form BA Pemeriksaan Sarana Pengisian -->
<div id="baModal" class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-[99999] hidden modal-container">
    <div class="bg-white dark:bg-gray-800 rounded-lg shadow-xl w-full max-w-4xl mx-4 max-h-[90vh] overflow-hidden">
        <div class="flex items-center justify-between p-6 border-b border-gray-200 dark:border-gray-700">
            <h3 id="modalTitle" class="text-lg font-semibold text-gray-900 dark:text-white">Form Tambah BA Pemeriksaan Sarana Pengisian</h3>
        ...
        <form id="baForm" class="overflow-auto max-h-[calc(90vh-120px)] p-6">
            @csrf
            <input type="hidden" id="baId" name="ba_id">

            <!-- Part 1: Informasi Kapal -->
            <div class="bg-blue-50 dark:bg-blue-900/20 rounded-lg p-4 mb-6">
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-4">
                    <div>
                        ...
                        <p class="text-xs text-gray-500 dark:text-gray-400 mt-1">Pilih kapal yang akan diperiksa sarana pengisiannya</p>
                    </div>
                    <div>
            ...
            <!-- Part 3: Pemeriksaan Sarana Pengisian -->
            <div class="bg-purple-50 dark:bg-purple-900/20 rounded-lg p-4 mb-6">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" id="penyedia" name="penyedia" required placeholder="Masukkan nama penyedia BBM..." class="w-full px-4 py-3 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-purple-500 dark:bg-gray-700 dark:text-white transition-colors">
                    <p class="text-xs text-gray-500 dark:text-gray-400 mt-1">Nama perusahaan atau penyedia BBM</p>
                </div>
                ...
                <div class="mb-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                        <label class="flex items-center p-4 border-2 border-gray-200 dark:border-gray-600 rounded-lg cursor-pointer hover:border-purple-300 hover:bg-purple-50 dark:hover:bg-purple-900/20 transition-all duration-200 group">
                            <input type="radio" name="jenis_tranport" value="1" class="mr-3 text-purple-600 focus:ring-purple-500 h-4 w-4">
                            <div>
                                <div class="font-medium text-gray-900 dark:text-white group-hover:text-purple-700 dark:group-hover:text-purple-300">Mobil</div>
                                <div class="text-sm text-gray-500 dark:text-gray-400">Pemeriksaan segel tangki</div>
                            </div>
                        </label>
                        <label class="flex items-center p-4 border-2 border-gray-200 dark:border-gray-600 rounded-lg cursor-pointer hover:border-purple-300 hover:bg-purple-50 dark:hover:bg-purple-900/20 transition-all duration-200 group">
                            <input type="radio" name="jenis_tranport" value="2" class="mr-3 text-purple-600 focus:ring-purple-500 h-4 w-4">
                            <div>
                                <div class="font-medium text-gray-900 dark:text-white group-hover:text-purple-700 dark:group-hover:text-purple-300">Kapal</div>
                                <div class="text-sm text-gray-500 dark:text-gray-400">Pemeriksaan flow meter</div>
                            </div>
                        </label>
                        <label class="flex items-center p-4 border-2 border-gray-200 dark:border-gray-600 rounded-lg cursor-pointer hover:border-purple-300 hover:bg-purple-50 dark:hover:bg-purple-900/20 transition-all duration-200 group">
                            <input type="radio" name="jenis_tranport" value="3" class="mr-3 text-purple-600 focus:ring-purple-500 h-4 w-4">
                            <div>
                                <div class="font-medium text-gray-900 dark:text-white group-hover:text-purple-700 dark:group-hover:text-purple-300">Pengisian Langsung</div>
                                <div class="text-sm text-gray-500 dark:text-gray-400">Pemeriksaan flow meter</div>
                            </div>
                        </label>
                    </div>
                ...
                <!-- Status Segel (Conditional - Mobil) -->
                <div id="status_segel_container" class="hidden mb-6">
                    <label class="block text-sm font-semibold text-gray-700 dark:text-gray-300 mb-3">
                        Kondisi Segel Tangki <span class="text-red-500">*</span>
                    </label>
                    <div class="grid grid-cols-2 gap-4">
                        <label class="flex items-center p-4 border-2 border-green-200 dark:border-green-600 rounded-lg cursor-pointer hover:border-green-300 hover:bg-green-50 dark:hover:bg-green-900/20 transition-all duration-200 group">
                            <input type="radio" name="status_segel" value="1" class="mr-3 text-green-600 focus:ring-green-500 h-4 w-4">
                            <div>
                                <div class="font-medium text-green-600 dark:text-green-400 group-hover:text-green-700 dark:group-hover:text-green-300">BAIK</div>
                                <div class="text-sm text-gray-500 dark:text-gray-400">Segel dalam kondisi baik</div>
                            </div>
                        </label>
                        <label class="flex items-center p-4 border-2 border-red-200 dark:border-red-600 rounded-lg cursor-pointer hover:border-red-300 hover:bg-red-50 dark:hover:bg-red-900/20 transition-all duration-200 group">
                            <input type="radio" name="status_segel" value="2" class="mr-3 text-red-600 focus:ring-red-500 h-4 w-4">
                            <div>
                                <div class="font-medium text-red-600 dark:text-red-400 group-hover:text-red-700 dark:group-hover:text-red-300">RUSAK</div>
                                <div class="text-sm text-gray-500 dark:text-gray-400">Segel dalam kondisi rusak</div>
                            </div>
                        </label>
                    </div>
                </div>

                <!-- Status Flow Meter (Conditional - Kapal/Pengisian Langsung) -->
                <div id="status_flowmeter_container" class="hidden mb-6">
                    <label class="block text-sm font-semibold text-gray-700 dark:text-gray-300 mb-3">
                        Kondisi Flow Meter <span class="text-red-500">*</span>
                    </label>
                    <div class="grid grid-cols-2 gap-4">
                        <label class="flex items-center p-4 border-2 border-green-200 dark:border-green-600 rounded-lg cursor-pointer hover:border-green-300 hover:bg-green-50 dark:hover:bg-green-900/20 transition-all duration-200 group">
                            <input type="radio" name="status_flowmeter" value="1" class="mr-3 text-green-600 focus:ring-green-500 h-4 w-4">
                            <div>
                                <div class="font-medium text-green-600 dark:text-green-400 group-hover:text-green-700 dark:group-hover:text-green-300">BAIK</div>
                                <div class="text-sm text-gray-500 dark:text-gray-400">Flow meter berfungsi baik</div>
                            </div>
                        </label>
                        <label class="flex items-center p-4 border-2 border-red-200 dark:border-red-600 rounded-lg cursor-pointer hover:border-red-300 hover:bg-red-50 dark:hover:bg-red-900/20 transition-all duration-200 group">
                            <input type="radio" name="status_flowmeter" value="2" class="mr-3 text-red-600 focus:ring-red-500 h-4 w-4">
                            <div>
                                <div class="font-medium text-red-600 dark:text-red-400 group-hover:text-red-700 dark:group-hover:text-red-300">RUSAK</div>
                                <div class="text-sm text-gray-500 dark:text-gray-400">Flow meter tidak berfungsi</div>
                            </div>
                        </label>
                    </div>
                </div>
                ...
                <!-- Gambar Segel -->
                <div id="gambar_segel_container" class="hidden mb-6">
                    <label for="gambar_segel" class="block text-sm font-semibold text-gray-700 dark:text-gray-300 mb-2">
                        Gambar Segel
                    </label>
                    <input type="file" id="gambar_segel" name="gambar_segel" accept="image/jpeg,image/png" class="w-full px-4 py-3 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-purple-500 dark:bg-gray-700 dark:text-white transition-colors">
                    <p class="text-xs text-gray-500 dark:text-gray-400 mt-1">Format: JPG, PNG (Max 2MB)</p>
                </div>

                <!-- Gambar Flow Meter -->
                <div id="gambar_flowmeter_container" class="hidden mb-6">
                    <label for="gambar_flowmeter" class="block text-sm font-semibold text-gray-700 dark:text-gray-300 mb-2">
                        Gambar Flow Meter
                    </label>
                    <input type="file" id="gambar_flowmeter" name="gambar_flowmeter" accept="image/jpeg,image/png" class="w-full px-4 py-3 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-purple-500 dark:bg-gray-700 dark:text-white transition-colors">
                    <p class="text-xs text-gray-500 dark:text-gray-400 mt-1">Format: JPG, PNG (Max 2MB)</p>
                </div>
                ...
                <div class="mb-6">
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        <label class="flex items-center p-4 border-2 border-green-200 dark:border-green-600 rounded-lg cursor-pointer hover:border-green-300 hover:bg-green-50 dark:hover:bg-green-900/20 transition-all duration-200 group">
                            <input type="radio" name="kesimpulan" value="1" class="mr-3 text-green-600 focus:ring-green-500 h-4 w-4">
                            <div>
                                <div class="font-medium text-green-600 dark:text-green-400 group-hover:text-green-700 dark:group-hover:text-green-300">DILAKUKAN</div>
                                <div class="text-sm text-gray-500 dark:text-gray-400">Pengisian dapat dilakukan</div>
                            </div>
                        </label>
                        <label class="flex items-center p-4 border-2 border-red-200 dark:border-red-600 rounded-lg cursor-pointer hover:border-red-300 hover:bg-red-50 dark:hover:bg-red-900/20 transition-all duration-200 group">
                            <input type="radio" name="kesimpulan" value="2" class="mr-3 text-red-600 focus:ring-red-500 h-4 w-4">
                            <div>
                                <div class="font-medium text-red-600 dark:text-red-400 group-hover:text-red-700 dark:group-hover:text-red-300">DITUNDA</div>
                                <div class="text-sm text-gray-500 dark:text-gray-400">Pengisian ditunda</div>
                            </div>
                        </label>
                    </div>
                </div>
            ...
            <div class="flex justify-end space-x-3 mt-6 pt-6 border-t border-gray-200 dark:border-gray-700">
                <button type="button" id="cancelBtn" class="px-4 py-2 text-gray-700 bg-gray-200 hover:bg-gray-300 dark:bg-gray-700 dark:text-gray-300 dark:hover:bg-gray-600 rounded-lg transition-colors font-medium">
                    Batal
                </button>
                <button type="submit" id="submitBtn" class="px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white rounded-lg transition-colors font-medium flex items-center">
                    <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
<script>
    $(document).ready(function() {
        ...
        /**
         * Handle perubahan jenis transportasi
         * @param {string} jenisTransport Nilai jenis transportasi (1, 2, atau 3)
         */
        function handleTransportChange(jenisTransport) {
            // Hide all conditional containers first
            $('#status_segel_container, #status_flowmeter_container, #gambar_segel_container, #gambar_flowmeter_container').addClass('hidden');

            // Reset radio buttons
            $('input[name="status_segel"], input[name="status_flowmeter"]').prop('checked', false);

            // Show relevant containers based on transport type
            if (jenisTransport === '1') {
                // Mobil - show segel container
                $('#status_segel_container, #gambar_segel_container').removeClass('hidden');
            } else if (jenisTransport === '2' || jenisTransport === '3') {
                // Kapal atau Pengisian Langsung - show flow meter container
                $('#status_flowmeter_container, #gambar_flowmeter_container').removeClass('hidden');
            }
        }
         ...
         * @param {number|string} jenis Kode jenis transportasi.
         * @returns {string} Teks jenis transportasi.
         */
        function getJenisTransportText(jenis) {
            const texts = {
                1: 'Mobil'
                , 2: 'Kapal'
                , 3: 'Pengisian Langsung'
            };
            return texts[jenis] || 'Unknown';
        }
   ...
   `);
        ...
        function resetForm() {
            $('#baForm')[0].reset();
            $('#modalTitle').text('Form Tambah BA Pemeriksaan Sarana Pengisian');
            ...
            $('.existing-image-preview').remove();
            $('#gambar_segel, #gambar_flowmeter').data('existing-file', null);
        ...
        function loadData() {
            ...
            $.ajax({
                url: '{{ route("ba-pemeriksaan-sarana-pengisian.data") }}'
                , type: 'GET'
                , data: params
                , beforeSend: function() {
                    showLoading();
        ...
        function loadKapalData(kapalId) {
            $.ajax({
                url: '{{ route("ba-pemeriksaan-sarana-pengisian.kapal-data") }}'
                , type: 'GET'
                , data: {
                    kapal_id: kapalId
                }
        ...
        function loadBaData(kapalId) {
            ...
            $.ajax({
                url: '{{ route("ba-pemeriksaan-sarana-pengisian.ba-data") }}'
                , type: 'GET'
                , data: {
                    kapal_id: kapalId
       ...
       <div class="mt-6">
           <div class="bg-purple-50 dark:bg-purple-900/20 rounded-lg p-4">
               <h6 class="text-lg font-semibold text-purple-900 dark:text-purple-100 mb-4">Pemeriksaan Sarana Pengisian</h6>
               <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                   <div class="flex justify-between">
                       <span class="text-sm font-medium text-gray-600 dark:text-gray-400">Penyedia BBM:</span>
                       <span class="text-sm font-semibold text-gray-900 dark:text-white">${data.penyedia || '-'}</span>
                   </div>
                   <div class="flex justify-between">
                       <span class="text-sm font-medium text-gray-600 dark:text-gray-400">Jenis Transportasi:</span>
                       <span class="text-sm font-semibold text-gray-900 dark:text-white">${getJenisTransportText(data.jenis_tranport)}</span>
                   </div>
                   <div class="flex justify-between">
                       <span class="text-sm font-medium text-gray-600 dark:text-gray-400">Status Segel:</span>
                       <span class="text-sm font-semibold text-gray-900 dark:text-white">${data.status_segel == 1 ? 'BAIK' : data.status_segel == 2 ? 'RUSAK' : 'Tidak Berlaku'}</span>
                   </div>
                   <div class="flex justify-between">
                       <span class="text-sm font-medium text-gray-600 dark:text-gray-400">Status Flow Meter:</span>
                       <span class="text-sm font-semibold text-gray-900 dark:text-white">${data.status_flowmeter == 1 ? 'BAIK' : data.status_flowmeter == 2 ? 'RUSAK' : 'Tidak Berlaku'}</span>
                   </div>
                   <div class="flex justify-between">
                       <span class="text-sm font-medium text-gray-600 dark:text-gray-400">Kesimpulan:</span>
                       <span class="text-sm font-semibold text-gray-900 dark:text-white">${data.kesimpulan == 1 ? 'DILAKUKAN' : data.kesimpulan == 2 ? 'DITUNDA' : '-'}</span>
                   </div>
               </div>
           </div>
       </div>
       ...
       <div class="mt-6">
           <div class="bg-gray-50 dark:bg-gray-800 rounded-lg p-4">
               <h6 class="text-lg font-semibold text-gray-900 dark:text-white mb-4">Gambar Pemeriksaan</h6>
               <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                   ${data.gambar_segel ? `
                   <div class="text-center">
                       <p class="text-sm font-medium text-gray-600 dark:text-gray-400 mb-2">Gambar Segel</p>
                       <img src="{{ url('dokumen/gambar_ba_sarana') }}/${data.gambar_segel}" alt="Gambar Segel" class="w-full h-48 object-cover rounded-lg border">
                   </div>
                   ` : ''}
                   ${data.gambar_flowmeter ? `
                   <div class="text-center">
                       <p class="text-sm font-medium text-gray-600 dark:text-gray-400 mb-2">Gambar Flow Meter</p>
                       <img src="{{ url('dokumen/gambar_ba_sarana') }}/${data.gambar_flowmeter}" alt="Gambar Flow Meter" class="w-full h-48 object-cover rounded-lg border">
                   </div>
                   ` : ''}
               </div>
           </div>
       ...
       `;
        ...
        function fillEditForm(data) {
            ...
            // Set jenis transportasi dan trigger conditional logic
            if (data.jenis_tranport) {
                $(`input[name="jenis_tranport"][value="${data.jenis_tranport}"]`).prop('checked', true);
                handleTransportChange(data.jenis_tranport);

                // Set status berdasarkan jenis transportasi
                if (data.jenis_tranport == 1 && data.status_segel) {
                    $(`input[name="status_segel"][value="${data.status_segel}"]`).prop('checked', true);
                } else if ((data.jenis_tranport == 2 || data.jenis_tranport == 3) && data.status_flowmeter) {
                    $(`input[name="status_flowmeter"][value="${data.status_flowmeter}"]`).prop('checked', true);
                }
            }
            ...
            if (data.gambar_segel) {
                showExistingImage('gambar_segel', data.gambar_segel);
            }
            if (data.gambar_flowmeter) {
                showExistingImage('gambar_flowmeter', data.gambar_flowmeter);
            }
        ...
        function showExistingImage(inputName, filename) {
            const container = $(`#${inputName}_container`);
            const input = $(`#${inputName}`);

            // Hapus preview yang sudah ada
            container.find('.existing-image-preview').remove();

            // Tambahkan preview gambar
            const imageUrl = `{{ url('dokumen/gambar_ba_sarana') }}/${filename}`;
            const previewHtml = `
                <div class="existing-image-preview mt-2">
                    <div class="flex items-center space-x-2 p-3 bg-gray-50 dark:bg-gray-700 rounded-lg">
                        <img src="${imageUrl}" alt="Gambar ${inputName}" class="w-16 h-16 object-cover rounded border">
                        <div class="flex-1">
                            ...
                            <button type="button" class="remove-existing-image-btn text-red-600 hover:text-red-800 text-xs mt-1" data-input-name="${inputName}">
            ...
            input.data('existing-file', filename);
        }

        function removeExistingImage(inputName) {
            ...
            const container = $(`#${inputName}_container`);
            const input = $(`#${inputName}`);
            const filename = input.data('existing-file');

            // Jika ada file yang tersimpan, hapus dari server
            if (filename && currentBaId) {
                $.ajax({
                    url: `{{ url('ba-pemeriksaan-sarana-pengisian') }}/${currentBaId}/delete-image`
                    , type: 'POST'
                    , data: {
                    ...
                    , success: function(response) {
                        if (response.success) {
                            ...
                            showNotification('error', 'Gagal menghapus gambar dari server: ' + response.message);
                        }
                    }
                    , error: function(xhr) {
                        showNotification('error', 'Terjadi kesalahan saat menghapus gambar dari server.');
                        console.error('AJAX Error delete image:', xhr);
                    }
                });
            }
            ...
            // Reset input file
            input.val('');
            input.data('existing-file', null);

            // Tampilkan pesan konfirmasi
            showNotification('success', 'Gambar berhasil dihapus. Anda dapat mengupload gambar baru.');

            // Optional: Tampilkan input file yang baru
        ...
        function setupEventHandlers() {
            ...
            // Jenis transportasi change handler
            $('input[name="jenis_tranport"]').on('change', function() {
            ...
            $('#deleteDocumentBtn').on('click', function() {
                if (confirm('Apakah Anda yakin ingin menghapus dokumen ini?')) {
                    $.ajax({
                        url: `/ba-pemeriksaan-sarana-pengisian/${currentBaId}/delete-document`
                        , type: 'DELETE'
                        , data: {
                            _token: '{{ csrf_token() }}'
                        }
        ...
        function handleFormSubmit(e) {
            ...
            let url = '{{ route("ba-pemeriksaan-sarana-pengisian.store") }}';
            let method = 'POST';

            if (currentEditMode) {
                url = `{{ url('ba-pemeriksaan-sarana-pengisian') }}/${currentBaId}`;
        ...
        function handleUploadSubmit(e) {
            ...
            $.ajax({
                url: `{{ url('ba-pemeriksaan-sarana-pengisian') }}/${currentBaId}/upload`
                , type: 'POST'
                , data: formData
                , processData: false
                , contentType: false
        ...
        function handleViewDocument() {
            ...
            $.ajax({
                url: `{{ url('ba-pemeriksaan-sarana-pengisian') }}/${baId}/view-document`
                , type: 'GET'
                , success: function(response) {
                    if (response.success) {
        ...
        function deleteDocument(baId) {
            ...
            $.ajax({
                url: `{{ url('ba-pemeriksaan-sarana-pengisian') }}/${baId}/delete-document`
        ...
        window.viewBa = function(id) {
            $.ajax({
                url: `{{ url('ba-pemeriksaan-sarana-pengisian') }}/${parseInt(id)}`
                , type: 'GET'
                , success: function(response) {
                    if (response.success) {
        ...
        window.editBa = function(id) {
            $.ajax({
                url: `{{ url('ba-pemeriksaan-sarana-pengisian') }}/${id}`
                , type: 'GET'
                , success: function(response) {
                    if (response.success) {
        ...
        window.generatePdf = function(baId) {
            ...
            $.ajax({
                url: `/ba-pemeriksaan-sarana-pengisian/${baId}/pdf`
                , type: 'GET'
        ...
        window.viewDocument = function(baId) {
            ...
            $.ajax({
                url: `/ba-pemeriksaan-sarana-pengisian/${baId}/view-document`
                , type: 'GET'
                , success: function(response) {
                    if (response.success) {
                        $('#documentViewer').html(`
                            <div class="text-center">
                                <div class="mb-4">
                                    ...
                                    <p class="text-sm text-gray-600 dark:text-gray-400">Dokumen pendukung BA Pemeriksaan Sarana Pengisian</p>
                        </div>
        ...
        <div class="relative mx-auto p-6 border w-11/12 md:w-4/5 lg:w-3/4 xl:w-2/3 shadow-lg rounded-lg bg-white dark:bg-gray-800 max-h-[95vh] overflow-y-auto">
            <div class="mt-3">
                <div class="flex items-center justify-between pb-6 border-b border-gray-200 dark:border-gray-700">
                    <div>
                        <h3 id="modalTitle" class="text-xl font-semibold text-gray-900 dark:text-white">Form Tambah BA Pemeriksaan Sarana Pengisian</h3>
                        <p class="text-sm text-gray-600 dark:text-gray-400 mt-1">Lengkapi data berikut untuk membuat Berita Acara Pemeriksaan Sarana Pengisian</p>
                    </div>
                    ...
                    <div class="bg-orange-50 dark:bg-orange-900/20 rounded-lg p-4">
                        ...
                        <div class="grid grid-cols-1 lg:grid-cols-2 gap-4">
                            <div>
                                ...
                                <input type="number" id="volume_sebelum" name="volume_sebelum" step="0.01" min="0" required class="w-full px-4 py-3 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-orange-500 focus:border-orange-500 dark:bg-gray-700 dark:text-white transition-colors">
                                <p class="text-xs text-gray-500 dark:text-gray-400 mt-1">Volume BBM di tangki sebelum pengukuran</p>
                            </div>
                            <div>
                                <label for="tanggal_sebelum" class="block text-sm font-semibold text-gray-700 dark:text-gray-300 mb-2">
                                    Tanggal Pengukuran Sebelumnya <span class="text-red-500">*</span>
                                </label>
                                <div class="relative">
                                    <input type="date" id="tanggal_sebelum" name="tanggal_sebelum" required class="w-full pl-4 pr-12 py-3 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-orange-500 focus:border-orange-500 dark:bg-gray-700 dark:text-white transition-colors">
                                    <div class="absolute inset-y-0 right-0 pr-3 flex items-center pointer-events-none">
                                        <svg class="w-5 h-5 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z"></path>
                                        </svg>
                            ...
                            <div>
                                <label for="volume_pengisian" class="block text-sm font-semibold text-gray-700 dark:text-gray-300 mb-2">
                                    Volume Pengisian Sebelumnya (Liter) <span class="text-red-500">*</span>
                                </label>
                                <input type="number" id="volume_pengisian" name="volume_pengisian" step="0.01" min="0" required class="w-full px-4 py-3 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-orange-500 focus:border-orange-500 dark:bg-gray-700 dark:text-white transition-colors">
                                <p class="text-xs text-gray-500 dark:text-gray-400 mt-1">Volume BBM yang diisi sebelumnya</p>
                            </div>
                            <div>
                                <label for="tanggal_pengisian" class="block text-sm font-semibold text-gray-700 dark:text-gray-300 mb-2">
                                    Tanggal Pengisian Sebelumnya <span class="text-red-500">*</span>
                                </label>
                                <div class="relative">
                                    <input type="date" id="tanggal_pengisian" name="tanggal_pengisian" required class="w-full pl-4 pr-12 py-3 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-orange-500 focus:border-orange-500 dark:bg-gray-700 dark:text-white transition-colors">
                                    <div class="absolute inset-y-0 right-0 pr-3 flex items-center pointer-events-none">
                                        <svg class="w-5 h-5 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z"></path>
                                        </svg>
                            ...
                            <div>
                                ...
                                <p class="text-xs text-gray-500 dark:text-gray-400 mt-1">Volume BBM di tangki saat ini</p>
                            </div>
                            <div>
                                <label for="volume_sisa" class="block text-sm font-semibold text-gray-700 dark:text-gray-300 mb-2">
                                    Jumlah Penggunaan (Liter) <span class="text-red-500">*</span>
                                </label>
                                ...
                                <p class="text-xs text-gray-500 dark:text-gray-400 mt-1">Dihitung otomatis: (Sebelum + Pengisian) - Saat Ini</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="bg-yellow-50 dark:bg-yellow-900/20 rounded-lg p-4">
                        ...
                        <div class="grid grid-cols-1 lg:grid-cols-2 gap-4">
                            ...
                            <div>
                                ...
                                <input type="text" id="peruntukan" name="peruntukan" placeholder="Contoh: Patroli rutin, Operasi khusus, dll" class="w-full px-4 py-3 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-yellow-500 focus:border-yellow-500 dark:bg-gray-700 dark:text-white transition-colors">
                            </div>
                        </div>
                    </div>
    ...
    <div class="flex items-center justify-center min-h-full py-8">
        <div class="relative mx-auto p-6 border w-11/12 md:w-3/4 lg:w-2/3 shadow-lg rounded-lg bg-white dark:bg-gray-800 max-h-[90vh] overflow-y-auto">
            <div class="mt-3">
                <div class="flex items-center justify-between pb-6 border-b border-gray-200 dark:border-gray-700">
                    <div>
                        <h3 class="text-xl font-semibold text-gray-900 dark:text-white">Detail BA Pemeriksaan Sarana Pengisian</h3>
                        <p class="text-sm text-gray-600 dark:text-gray-400 mt-1">Informasi lengkap Berita Acara Pemeriksaan Sarana Pengisian</p>
                    </div>
