...
*/
class Ba_penerima_hibah_bbm_instansi_lain {
    ...
    function edit() {
		...
		$volume_pengisian = str_replace(',','',$_POST['volume_pengisianEd']);
		...
		$q = $ci->db->query("UPDATE bbm_kapaltrans SET
				...
				volume_pengisian          = ".$volume_pengisian.",
				...
				an_kkm               = ".$an_kkm.",
				kapal_code_temp  		= '".$_POST['kapal_code_temp']."',
				keterangan_jenis_bbm 	= '".$_POST['keterangan_jenis_bbm']."',
				sebab_temp			= '".$_POST['sebab_temp']."',
				pangkat_nahkoda		= '".$_POST['pangkat_nahkoda']."',
				nama_nahkoda_temp	= '".$_POST['nama_nahkoda_temp']."',
				pangkat_nahkoda_temp = '".$_POST['pangkat_nahkoda_temp']."',
				nip_nahkoda_temp 	= '".$_POST['nip_nahkoda_temp']."',
				nama_kkm_temp = '".$_POST['nama_kkm_temp']."',
				nip_kkm_temp = '".$_POST['nip_kkm_temp']."',
