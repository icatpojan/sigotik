...
class Ba_penggunaan_bbm {
    ...
    function create() {
		...
		$volume_sisa = ($volume_sebelum + $volume_pengisian) - $volume_pemakaian;
		
		$tanggal_surat = date("Y-m-d", strtotime($_POST['tanggal_surat']));
		$tanggal_sebelum = date("Y-m-d", strtotime($_POST['tanggal_sebelum']));
		
	
	    $tanggal_pengisian = date("Y-m-d", strtotime($_POST['tanggal_pengisian']));
    ...
    function edit() {
		...
		$volume_pemakaianx = str_replace(',','',$_POST['volume_pemakaianx']);
		
		$volume_sisax = ($volume_sebelumx + $volume_pengisianx) - $volume_pemakaianx;
