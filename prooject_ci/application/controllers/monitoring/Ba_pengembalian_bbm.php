...
class Ba_pengembalian_bbm extends CI_Controller {
	...
	public function getDataTable(){
		...
		$sql = "SELECT * 
					FROM bbm_kapaltrans a WHERE status_ba = 9
	...
	function getDataEdit($trans_id){
    	...
    	$sql2 = "SELECT * FROM `bbm_kapaltrans` WHERE nomor_surat = '".$list->link_modul_ba."' "; 
		...
		$ed .= '
            ...
            <div class="row">
				  <div class="col-md-3 ">
					...
					<input type="text" name="tanggal_surat_penitip" id="tanggal_surat_penitip" class="form-control datepicker" readonly="" value="'.date("d-m-Y", strtotime($list2->tanggal_surat)).'">
				 </div>
				 
				 	<div class="col-md-5 ">
					<div class="form-group">
						<label>NOMOR BA PENITIPAN</label>
						<input type="text" name="nomor_surat_penitip" id="nomor_surat_penitip" class="form-control" disabled value="'.$list2->nomor_surat.'">
					</div>
				</div>	
			</div>
            ...
            <div class="row">
			    <div class="col-md-4">
					...
					<input type="text" placeholder="" id="penyedia_penitip" name="penyedia_penitip" class="form-control" value="'.$list->penyedia_penitip.'">
				 </div>
				 <div class="col-md-6">
					<label>ALAMAT PENYEDIA</label>
					<input type="text" placeholder="" id="alamat_penyedia_penitip" name="alamat_penyedia_penitip" class="form-control" value="'.$list->alamat_penyedia_penitip.'">
				 </div>
            </div></br>
            <div class="row">                 
			    <div class="col-md-4">
					<label>NAMA </label>
					<input type="text" placeholder="" id="nama_penitip" name="nama_penitip" class="form-control" value="'.$list->nama_penitip.'">
				 </div>
                 <div class="col-md-4">
					<label>JABATAN</label>
					<input type="text" placeholder="" id="jabatan_penitip" name="jabatan_penitip" class="form-control" value="'.$list->jabatan_penitip.'">
				 </div>           
			    
				<div class="col-md-8 ">
					<label>ALAMAT PENITIPAN</label>
					<input type="text" placeholder="" id="alamat_penitip" name="alamat_penitip" class="form-control" value="'.$list->alamat_penitip.'">
				 </div>
            ...
            <div class="row">
				...
				<div class="col-md-4 ">
					<div class="form-group">
						...
						<input type="text" name="volume_sebelum" id="volume_sebelum" class="form-control angka" value="'.number_format($list->volume_sebelum).'" onkeypress="validate(event)" readonly="">
					</div>
				</div>
                            
				<div class="col-md-4 ">
					<div class="form-group">
						<label>JUMLAH PENITIPAN BBM</label>
						<input type="text" name="penggunaan" id="penggunaan" class="form-control angka" value="'.number_format($list->penggunaan).'" onkeypress="validate(event)" readonly="">
					</div>
				</div>
             ...
             <div class="row">
                ...
                <div class="col-md-4 ">
					<div class="form-group">
						<label>VOLUME TANGKI BBM PENGUKURAN SAAT INI</label>
						   <input type="text" placeholder="" id="volume_pemakaian" name="volume_pemakaian" class="form-control angka" value="'.number_format($list->volume_pemakaian).'" onkeypress="validate(event)">
					</div>
				</div>
				...
				<div class="col-md-4 ">
					<div class="form-group">
						...
						<input type="text" name="keterangan_jenis_bbm" id="keterangan_jenis_bbm" class="form-control" value="'.$list->keterangan_jenis_bbm.'">
					</div>
				</div>
	...
	function getDataLihat($trans_id){
		...
		$ed .= '
            ...
            <div class="row">
				  <div class="col-md-3 ">
					<label>TANGGAL PENITIPAN</label>
					<input type="text" name="tanggal_surat_penitip" id="tanggal_surat_penitip" class="form-control datepicker" readonly="" value="'.date("d-m-Y", strtotime($list2->tanggal_surat)).'" readonly="">
				 </div>
				 
				 	<div class="col-md-5 ">
					<div class="form-group">
						<label>NOMOR BA PENITIPAN</label>
						<input type="text" name="nomor_surat_penitip" id="nomor_surat_penitip" class="form-control" disabled value="'.$list2->nomor_surat.'" readonly="">
					</div>
				</div>	
			</div>
            ...
            <div class="row">
			    <div class="col-md-4">
					<label>PENYEDIA</label>
					<input type="text" placeholder="" id="penyedia_penitip" name="penyedia_penitip" class="form-control" value="'.$list->penyedia_penitip.'"readonly="">
				 </div>
				 <div class="col-md-6">
					<label>ALAMAT PENYEDIA</label>
					<input type="text" placeholder="" id="alamat_penyedia_penitip" name="alamat_penyedia_penitip" class="form-control" value="'.$list->alamat_penyedia_penitip.'"readonly="">
				 </div>
            </div></br>
            <div class="row">                 
			    <div class="col-md-4">
					<label>NAMA </label>
					<input type="text" placeholder="" id="nama_penitip" name="nama_penitip" class="form-control" value="'.$list->nama_penitip.'"readonly="">
				 </div>
                 <div class="col-md-4">
					<label>JABATAN</label>
					<input type="text" placeholder="" id="jabatan_penitip" name="jabatan_penitip" class="form-control" value="'.$list->jabatan_penitip.'"readonly="">
				 </div>           
			    
				<div class="col-md-8 ">
					<label>ALAMAT PENITIPAN</label>
					<input type="text" placeholder="" id="alamat_penitip" name="alamat_penitip" class="form-control" value="'.$list->alamat_penitip.'"readonly="">
				 </div>
			...
			<div class="row">
             ...
             <div class="row">
                ...
                <div class="col-md-4 ">
					<div class="form-group">
						<label>VOLUME TANGKI BBM PENGUKURAN SAAT INI</label>
						   <input type="text" placeholder="" id="volume_pemakaian" name="volume_pemakaian" class="form-control angka" value="'.number_format($list->volume_pemakaian).'" onkeypress="validate(event)" readonly="">
					</div>
				</div>
				...
				<div class="col-md-4 ">
					<div class="form-group">
						<label>JENIS BBM</label>
						<input type="text" name="keterangan_jenis_bbm" id="keterangan_jenis_bbm" class="form-control" value="'.$list->keterangan_jenis_bbm.'" readonly="">
					</div>
				</div>
	...
	function getDataPenitip(){
	    $ci = & get_instance();
	    
	    $tanggal_surat = date("y-m-d", strtotime($_POST['tanggal_surat_penitip']));
	    
		$sql = "SELECT * FROM `bbm_kapaltrans` 
		            JOIN `m_kapal` ON `m_kapal`.code_kapal = `bbm_kapaltrans`.kapal_code
		    WHERE tanggal_surat = '".$tanggal_surat."' AND status_ba IN (8) AND link_modul_ba = '' AND m_kapal.m_kapal_id = ".$_POST['m_kapal_id']." 
		    ORDER BY jam_surat DESC LIMIT 1"; 
		
	    //var_dump($_POST['nomor_surat_penitip']);die();
		$query = $ci->db->query($sql);
		...
		if($total>0){
		    ...
		    $data['penggunaan'] = $list->penggunaan;
            $data['volume_sebelum'] = $list->volume_sebelum;
