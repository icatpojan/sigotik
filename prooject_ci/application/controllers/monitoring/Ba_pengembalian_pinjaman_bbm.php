...
class Ba_pengembalian_pinjaman_bbm extends CI_Controller {
	...
	public function getDataTable(){
		...
		$sql = "SELECT * 
					FROM bbm_kapaltrans a WHERE status_ba = 12
	...
	function getDataEdit($trans_id){
		...
		$sql2 = "SELECT * FROM `bbm_kapaltrans` WHERE nomor_surat = '".$list->link_modul_temp."' "; 
		// var_dump($sql2);die();
		...
		$ed .= '
			...
			<div class="row">
				...
				<div class="col-md-3">
					<div class="form-group">
						<label>No BA Pemberi Pinjaman</label>
				...
				<div class="col-md-3 ">
					...
					<input type="text" name="tanggal_peminjaman" id="tanggal_peminjaman" class="form-control datepicker" value="'.date("d-m-Y", strtotime($list->tanggal_surat)).'" disabled>
				 </div>
				 
				<input type="hidden" id="link_modulTemp" name="link_modulTemp" class="form-control" value="'.$list->link_modul_temp.'">
				
				<div class="col-md-3 ">
					<div class="form-group">
						<label>KODE KAPAL Pemberi Pinjaman</label>
						<input type="text" name="kapal_code_temp" id="kapal_code_temp" readonly="" class="form-control" value="'.$list->kapal_code_temp.'">
					</div>
				</div>
			...
			<div class="row">
				...
				<div class="col-md-4">
					...
					<input type="text" name="volume_sebelum" id="volume_sebelum" class="form-control angka" onkeypress="validate(event)" value="'.number_format($list->volume_sebelum).'" readonly="">
				 </div>
				 
				 <div class="col-md-5">
					<label>Jumlah BBM Pengembalian Pinjaman</label>
					<input type="text" name="volume_pemakaian" id="volume_pemakaian" class="form-control angka" value="'.number_format($list->volume_pemakaian).'" readonly="">
				 </div>
				 
				 <div class="col-md-5">
					<label>Sisa BBM</label>
					<input type="text" name="volume_sisa" id="volume_sisa" class="form-control angka" onkeypress="validate(event)" value="'.number_format($list->volume_sisa).'" readonly="">
				 </div><br><br>
			</div>
			...
			<br>
				 <div class="col-md-4 ">
					...
					<input type="text" placeholder="" id="nama_nahkoda_temp" name="nama_nahkoda_temp" class="form-control" value="'.$list->nama_nahkoda_temp.'" readonly="">
				 </div>
				 ...
				 <div class="col-md-4 ">
					<label>NIP </label>
						<input type="text" placeholder="" id="nip_nahkoda_temp" name="nip_nahkoda_temp" class="form-control" value="'.$list->nip_nahkoda_temp.'" readonly="">
				 </div>
			 </div>
			...
			<br>
				 <div class="col-md-4 ">
					...
					<input type="text" placeholder="" id="nama_kkm_temp" name="nama_kkm_temp" class="form-control" value="'.$list->nama_kkm_temp.'" readonly="">
				 </div>
				 
				 <div class="col-md-4 ">
					<label>NIP </label>
						<input type="text" placeholder="" id="nip_kkm_temp" name="nip_kkm_temp" class="form-control" value="'.$list->nip_kkm_temp.'" readonly="">
				 </div>
