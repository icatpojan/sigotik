...
class Ba_penitipan_bbm extends CI_Controller {
	...
	public function getDataTable(){
		...
		$sql = "SELECT * 
					FROM bbm_kapaltrans a WHERE status_ba = 8
	...
	function getDataEdit($trans_id){
		...
		$ed .= '
            ...
            <div class="row">
				...
				<div class="col-md-5 ">
					<div class="form-group">
						<label>VOLUME TANGKI PENGUKURAN</label>
						<input type="text" name="volume_sebelum" name="volume_sebelum" value="'.number_format($list->volume_sebelum).'" class="form-control angka" value="" onkeypress="validate(event)">
					</div>
				</div>
				...
				<div class="col-md-5 ">
					<div class="form-group">
						...
						<input type="text" name="penggunaan" name="penggunaan" class="form-control angka" value="'.number_format($list->penggunaan).'" onkeypress="validate(event)" >
					</div>
				</div>
			</div>
		...
		$ed .= '
			...
			<div class="row">
				...
				<div class="col-md-5 ">
					<div class="form-group">
						<label>VOLUME TANGKI PENGUKURAN</label>
						<input type="text" name="volume_sebelum" name="volume_sebelum" value="'.number_format($list->volume_sebelum).'" class="form-control angka" value="" onkeypress="validate(event)" readonly="">
					</div>
				</div>
				...
				<div class="col-md-5 ">
					<div class="form-group">
						<label>JUMLAH PENITIPAN BBM</label>
						<input type="text" name="penggunaan" name="penggunaan" class="form-control angka" value="'.number_format($list->penggunaan).'" onkeypress="validate(event)" readonly="">
					</div>
				</div>
			</div>
