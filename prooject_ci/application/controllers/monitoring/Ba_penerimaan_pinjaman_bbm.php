...
class Ba_penerimaan_pinjaman_bbm extends CI_Controller {
	...
	public function getDataTable(){
		...
		$sql = "SELECT * 
					FROM bbm_kapaltrans a WHERE status_ba = 11
			...
			<div class="row">
				...
				<div class="col-md-3">
					<div class="form-group">
						...
						<input type="text" placeholder="" id="link_modulTemp" name="link_modul" class="form-control" value="'.$list->link_modul_temp.'" readonly="">
					</div>
				</div>
				...
				<div class="col-md-3 ">
					...
					<input type="text" name="tanggal_peminjaman" id="tanggal_peminjaman" class="form-control datepicker" value="'.date("d-m-Y", strtotime($list2->tanggal_surat)).'" disabled>
				 </div>
