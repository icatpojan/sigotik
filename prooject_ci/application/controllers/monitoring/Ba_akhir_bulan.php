...
class Ba_akhir_bulan extends CI_Controller {
	...
	public function getDataTable(){
		...
		$sql = "SELECT * 
					FROM bbm_kapaltrans a WHERE status_ba = 1
			...
			<div class="row">
				...
				<div class="col-md-4 ">
					<div class="form-group">
						...
						<textarea id="lokasi_surat" name="lokasi_surat" rows="3" cols="50" class="form-control">'.$rx->lokasi_surat.'</textarea>
					</div>
				</div>
			...
			<div class="row">
				...
				<div class="col-md-7 ">
					<div class="form-group">
						<label>SISA BBM AKHIR BULAN SEBELUMNYA </label>
						 <input type="text" placeholder="" id="volume_sebelumx" name="volume_sebelumx" class="form-control angka" value="'.number_format($list->volume_sebelum).'" onkeypress="validate(event)" onkeyup="getPenggunaanx()">
					</div>
				</div>
				...
				<div class="col-md-7 ">
					<div class="form-group">
						...
						<input type="text" placeholder="" id="tanggal_sebelumx" name="tanggal_sebelumx" class="form-control datepicker" value="'.date("d-m-Y", strtotime($list->tanggal_sebelum)).'">
					</div>
				</div>
				...
				<div class="col-md-7 ">
					<div class="form-group">
						<label>VOLUME PENGISIAN</label>
						  <input type="text" placeholder="" id="volume_pengisianx" name="volume_pengisianx" class="form-control angka" value="'.number_format($list->volume_pengisian).'" onkeypress="validate(event)" onkeyup="getPenggunaanx()">
					</div>
				</div>
				...
				<div class="col-md-7 ">
					<div class="form-group">
						<label>VOLUME BBM AKHIR BULAN SAAT INI</label>
						   <input type="text" placeholder="" id="volume_sisax" name="volume_sisax" class="form-control angka" value="'.number_format($list->volume_sisa).'" onkeypress="validate(event)" onkeyup="getPenggunaanx()">
					</div>
				</div>
				...
				<div class="col-md-7 ">
					<div class="form-group">
						<label>VOLUME PEMAKAIAN</label>
						   <input type="text" placeholder="" id="volume_pemakaianx" name="volume_pemakaianx" class="form-control angka" value="'.number_format($list->volume_pemakaian).'" disabled>
					</div>
				</div>
			</div>
		...
		$ed .= '
			...
			<div class="row">
				...
				<div class="col-md-7 ">
					<div class="form-group">
						<label>SISA BBM AKHIR BULAN SEBELUMNYA </label>
						 <input type="text" placeholder="" id="volume_sebelumx" name="volume_sebelumx" class="form-control angka" value="'.number_format($list->volume_sebelum).'" onkeypress="validate(event)" onkeyup="getPenggunaanx()" readonly="">
					</div>
				</div>
				...
				<div class="col-md-7 ">
					<div class="form-group">
						<label>TANGGAL BA AKHIR BULAN SEBELUMNYA</label>
						<input type="text" placeholder="" id="tanggal_sebelumx" name="tanggal_sebelumx" class="form-control datepicker" value="'.date("d-m-Y", strtotime($list->tanggal_sebelum)).'" disabled>
					</div>
				</div>
				...
				<div class="col-md-7 ">
					<div class="form-group">
						<label>VOLUME PENGISIAN</label>
						  <input type="text" placeholder="" id="volume_pengisianx" name="volume_pengisianx" class="form-control angka" value="'.number_format($list->volume_pengisian).'" onkeypress="validate(event)" onkeyup="getPenggunaanx()" readonly="">
					</div>
				</div>
				...
				<div class="col-md-7 ">
					<div class="form-group">
						<label>VOLUME BBM AKHIR BULAN SAAT INI</label>
						   <input type="text" placeholder="" id="volume_sisax" name="volume_sisax" class="form-control angka" value="'.number_format($list->volume_sisa).'" onkeypress="validate(event)" onkeyup="getPenggunaanx()" readonly="">
					</div>
				</div>
