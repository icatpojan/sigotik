...
class Ba_sisa_sblm_pengisian extends CI_Controller {
	...
	public function getDataTable(){
		...
		$sql = "SELECT * 
					FROM bbm_kapaltrans a WHERE status_ba = 2
	...
	public function getData(){
		...
		foreach ($query->result() as $list){
			...
			$data['nama_nakoda'] = $list->nama_nakoda;
			$data['nip_nakoda'] = $list->nip_nakoda;
			$data['nama_kkm'] = $list->nama_kkm;
			$data['nip_kkm'] = $list->nip_kkm;
			$data['nama_petugas'] = $list->nama_petugas;
			$data['nip_petugas'] = $list->nip_petugas;
			$data['zona_waktu_upt'] = $list->zona_waktu_upt;
			$data['kota'] = $list->kota;
			$data['jabatan_petugas'] = $list->jabatan_petugas;
			...
			<div class="row">
				...
				<div class="col-md-7 ">
					<div class="form-group">
						...
						<input type="text" name="volume_sisa" name="volume_sisa" class="form-control angka" onkeypress="validate(event)" value="'.number_format($list->volume_sisa).'">
					</div>
				</div>
		...
		$ed .= '
			...
			<div class="row">
				...
				<div class="col-md-7 ">
					<div class="form-group">
						<label>SISA BBM SEBELUM PENGISIAN</label>
						<input type="text" name="volume_sisa" name="volume_sisa" class="form-control angka" onkeypress="validate(event)" value="'.number_format($list->volume_sisa).'" readonly="">
					</div>
				</div>
	...
	function getCetak(){
        ...
        <table border="1">
              <tr>
                    <th> <b>CETAK BA SISA SEBELUM PENGISIAN</b> </th>
        ...
        //exit($pdf->Output('VivesPromocion.pdf', 'I'));
        $pdf->Output();
