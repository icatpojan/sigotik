...
class Ba_penerima_hibah_bbm_instansi_lain extends CI_Controller {
	...
	public function getDataTable(){
		...
		$sql = "SELECT * 
					FROM bbm_kapaltrans a WHERE status_ba = 18
	...
	function getDataEdit($trans_id){
		...
		$ed .= '
			...
			<div class="row">
				...
				<div class="col-md-4 ">
					<div class="form-group">
						<label>Nama Kapal Pemberi Hibah</label>
						<input type="text" name="kapal_code_temp" id="kapal_code_temp" class="form-control" value="'.$list->kapal_code_temp.'">
					</div>
				</div>
			...
			<div class="row">
				...
				<div class="col-md-4">
				 ...
				 <div class="col-md-5">
					...
					<input type="text" name="volume_pengisianEd" id="volume_pengisianEd" class="form-control angka" onkeypress="validate(event)" onChange="validateVolume(1)" onclick="validateOnClik(1)" value="'.number_format($list->volume_pengisian).'" >
				 </div>
			...
			<div class="row">
			   ...
			   <div class="col-md-7 ">
					<div class="form-group">
						...
						<textarea id="sebab_temp" name="sebab_temp" rows="3" cols="50" class="form-control" onChange="validateVolume(1)" >'.$list->sebab_temp.'</textarea>
					</div>
				</div>
			...
			<br>
				 <div class="col-md-4 ">
					...
					<input type="text" placeholder="" id="nama_nahkoda_temp" name="nama_nahkoda_temp" class="form-control" value="'.$list->nama_nahkoda_temp.'">
				 </div>
				 ...
				 <div class="col-md-4 ">
					<label>NIP </label>
						<input type="text" placeholder="" id="nip_nahkoda_temp" name="nip_nahkoda_temp" class="form-control" value="'.$list->nip_nahkoda_temp.'">
				 </div>
			 </div>
			...
			<br>
				 <div class="col-md-4 ">
					...
					<input type="text" placeholder="" id="nama_kkm_temp" name="nama_kkm_temp" class="form-control" value="'.$list->nama_kkm_temp.'">
				 </div>
				 
				 <div class="col-md-4 ">
					<label>NIP </label>
						<input type="text" placeholder="" id="nip_kkm_temp" name="nip_kkm_temp" class="form-control" value="'.$list->nip_kkm_temp.'">
				 </div>
		...
		$ed .= '
			...
			<div class="row">
				...
				<div class="col-md-4">
				 ...
				 <div class="col-md-5">
					<label>Jumlah BBM Di Pinjamkan</label>
					<input type="text" name="volume_pengisianEd" id="volume_pengisianEd" class="form-control angka" onkeypress="validate(event)" onChange="validateVolume(1)" value="'.number_format($list->volume_pengisian).'" readonly="">
				 </div>
