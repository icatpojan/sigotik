...
$(document).ready(function() {
	...
	$('#data_tables').dataTable({
		...
		'sAjaxSource'    : '<?php echo base_url()?>index.php/angta/anggaran/getDataTableAngaranInternalApp',
...
function getTab3(id){
	...
	var app = confirm("Apakah Kamu Yakin Untuk Approve Data Ini?");
	if (app){
		
	   $.ajax({
		type : 'POST',
		url: '<?php echo WS_JQGRID."angta.anggaran/approvInternal"; ?>',
		data : datForm,
		dataType : 'json',
