...
<div class="row">
    <ul id="tabs">
      ...
      <li><a id="tab1" onClick="getTab1()">Laporan Detail Penggunaan dan Penerimaan BBM Per Kapal</a></li>
...
function preview(){
	...
	var m_kapal_nama = $("#m_kapal_nama").val();
	$('#isiData').load('<?php echo base_url()?>index.php/lap/lap/showdtotalpakaibbm3/'+tgl_awal+'/'+tgl_akhir+"/"+m_kapal_id+"/"+m_kapal_nama);
}
...
function toprint(){
	...
	var xx = '<?php echo base_url()?>'+'index.php/lap/lap_cetak/showdtotalpakaibbm3/'+tgl_awal+'/'+tgl_akhir+"/"+m_kapal_id+"/"+m_kapal_nama;
...
function toexcel(){
	...
	var xx = '<?php echo base_url()?>'+'index.php/lap/lap_excel/showdtotalpakaibbm3/'+tgl_awal+'/'+tgl_akhir+"/"+m_kapal_id+"/"+m_kapal_nama;
	var x = window.open(xx,'_blank');
    x.focus();
}
...
function getVal(){
	...
	$.ajax({
		type : "POST",
		url	: "<?php echo base_url()?>index.php/monitoring/ba_penerimaan_bbm/getData",
