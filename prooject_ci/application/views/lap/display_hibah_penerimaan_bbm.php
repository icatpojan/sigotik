...
<div class="row">
    <ul id="tabs">
      ...
      <li><a id="tab1" onClick="getTab1()">Laporan Hibah Penerimaan BBM</a></li>
...
function preview(){
	...
	$('#isiData').load('<?php echo base_url()?>index.php/lap/lap/prevhibahpenerimaanbbm/'+tgl_awal+'/'+tgl_akhir+'/'+code+'/'+code_kapal);
}
