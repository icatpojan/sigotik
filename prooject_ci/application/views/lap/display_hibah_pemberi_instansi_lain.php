...
<div class="row">
    <ul id="tabs">
      ...
      <li><a id="tab1" onClick="getTab1()">Laporan Hibah Pemberian BBM Dengan Instansi Lain</a></li>
...
function preview(){
	...
	$('#isiData').load('<?php echo base_url()?>index.php/lap/lap/prevhibahpemberiInstansiLain/'+tgl_awal+'/'+tgl_akhir+'/'+code+'/'+code_kapal);
}
...
function toprint(){
	...
	var xx = '<?php echo base_url()?>'+'index.php/lap/lap_cetak/prevhibahpemberiInstansiLain_print/'+tgl_awal+'/'+tgl_akhir+'/'+code+'/'+code_kapal;
...
function toexcel(){
	...
	var xx = '<?php echo base_url()?>'+'index.php/lap/lap_excel/prevhibahpemberiInstansiLain_xl/'+tgl_awal+'/'+tgl_akhir+'/'+code+'/'+code_kapal;
	var x = window.open(xx,'_blank');
    x.focus();
}
</script>