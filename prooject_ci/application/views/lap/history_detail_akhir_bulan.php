...
<div class="row">
    <ul id="tabs">
      ...
      <li><a id="tab1" onClick="getTab1()">Laporan Detail Akhir Bulan BBM Per Kapal</a></li>
...
function preview(){
	...
	$('#isiData').load('<?php echo base_url()?>index.php/lap/lap/showdtotalpakaibbm4/'+tgl_awal+'/'+tgl_akhir+"/"+m_kapal_id+"/"+m_kapal_nama);
}
...
function toprint(){
	...
	var m_kapal_id = $("#m_kapal_id").val();
	var m_kapal_nama = $("#m_kapal_nama").val();
	var xx = '<?php echo base_url()?>'+'index.php/lap/lap_cetak/showdtotalpakaibbm4/'+tgl_awal+'/'+tgl_akhir+"/"+m_kapal_id+"/"+m_kapal_nama;
...
function toexcel(){
	...
	var m_kapal_id = $("#m_kapal_id").val();
	var m_kapal_nama = $("#m_kapal_nama").val();
	var xx = '<?php echo base_url()?>'+'index.php/lap/lap_excel/showdtotalpakaibbm4/'+tgl_awal+'/'+tgl_akhir+"/"+m_kapal_id+"/"+m_kapal_nama;
	var x = window.open(xx,'_blank');
    x.focus();
}
