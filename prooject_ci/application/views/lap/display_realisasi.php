...
<div class="row">
    <ul id="tabs">
      ...
      <li><a id="tab1" onClick="getTab1()">Realisasi Tagihan BBM Per UPT</a></li>
...
function previews(){
			...
			$('#isiData').load('<?php echo base_url()?>index.php/lap/lap/showdtagihanupt/'+periode+'/'+code);
		}
...
function toprint(){
	...
	var xx = '<?php echo base_url()?>'+'index.php/lap/lap_cetak/showdtagihanupt/'+periode+'/'+code;
...
function toexcel(){
	...
	var xx = '<?php echo base_url()?>'+'index.php/lap/lap_excel/showdtagihanupt/'+periode+'/'+code;
	var x = window.open(xx,'_blank');
    x.focus();
}		

function Export_xl(x){
	
	var xx = '<?php echo base_url()?>'+'index.php/lap/lap_excel/showdtagihanuptRinci/'+x;
	var x = window.open(xx,'_blank');
    x.focus();
