...
<div class="row">
	...
	<ul id="tabs">
      ...
      <li><a id="tab1" onClick="getTab1()">Data Notifikasi</a></li>
      <li><a id="tab2">Form Notifikasi</a></li>
...
$(document).ready(function() {
	...
	$('#data_table').dataTable({
			...
			'sAjaxSource'    : '<?php echo base_url()?>index.php/notif/notif/getDataTablenotif',
...
function getTab2(id){
	$('#tab2').show();
	$('#isiData').load('<?php echo base_url()?>index.php/notif/notif/getDataForm/'+id);
	$('#tab2').click();
}
...
function simpan(){
	...
	$.ajax({
		type : 'POST',
		url: '<?php echo WS_JQGRID."notif.notif/create"; ?>',
		data : x,
		dataType : 'json',
