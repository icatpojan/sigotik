...
class CreateBbmKapaltransTable extends Migration
{
    public function up(): void
    {
        Schema::create('bbm_kapaltrans', function (Blueprint $table) {
            ...
            $table->string('penyedia', 30)->default('')->comment('nama pt penyedia'); // DIKURANGI DARI 50
            ...
            $table->string('jabatan_staf_pangkalan', 30)->default(''); // DIKURANGI DARI 50
            $table->string('nama_staf_pangkalan', 30)->default(''); // DIKURANGI DARI 50
            $table->string('nip_staf', 20)->default(''); // DIKURANGI DARI 25
            $table->integer('an_staf')->default(0);

            // Informasi Nakhoda (Utama)
            $table->string('nama_nahkoda', 30)->default(''); // DIKURANGI DARI 50
            $table->string('nip_nahkoda', 20)->default(''); // DIKURANGI DARI 25
            $table->string('jabatan_nahkoda', 30)->nullable(); // DIKURANGI DARI 50
            $table->string('pangkat_nahkoda', 30)->nullable(); // DIKURANGI DARI 50
            $table->string('golongan_nahkoda', 30)->nullable(); // DIKURANGI DARI 50
            ...
            $table->string('golongan_kkm', 30)->nullable(); // DIKURANGI DARI 50
            $table->integer('an_kkm')->default(0);

            // Informasi Atas Nama (An.)
            $table->string('nama_an', 30)->nullable(); // DIKURANGI DARI 50
            $table->string('nip_an', 20)->nullable(); // DIKURANGI DARI 25
            $table->string('jabatan_an', 30)->nullable(); // DIKURANGI DARI 50
            $table->string('pangkat_an', 30)->nullable(); // DIKURANGI DARI 50
            $table->string('golongan_an', 30)->nullable(); // DIKURANGI DARI 50

            // Kolom Peruntukan dan Penitip
            $table->string('peruntukan', 50)->nullable(); // DIKURANGI DARI 70
            $table->decimal('penggunaan', 10, 2)->nullable();
            $table->string('nama_penitip', 30)->nullable(); // DIKURANGI DARI 50
            $table->string('jabatan_penitip', 30)->nullable(); // DIKURANGI DARI 50
            $table->text('alamat_penitip')->nullable(); // TETAP TEXT
            $table->string('penyedia_penitip', 50)->nullable(); // DIKURANGI DARI 100
            ...
            $table->string('nama_nahkoda_temp', 30)->nullable(); // DIKURANGI DARI 50
            $table->string('nip_nahkoda_temp', 20)->nullable(); // DIKURANGI DARI 25
            $table->string('jabatan_nahkoda_temp', 30)->nullable(); // DIKURANGI DARI 50
            $table->string('pangkat_nahkoda_temp', 30)->nullable(); // DIKURANGI DARI 50
            $table->string('golongan_nahkoda_temp', 30)->nullable(); // DIKURANGI DARI 50
            $table->string('nama_kkm_temp', 30)->nullable(); // DIKURANGI DARI 50
            $table->string('nip_kkm_temp', 20)->nullable(); // DIKURANGI DARI 25
            $table->string('jabatan_kkm_temp', 30)->nullable(); // DIKURANGI DARI 50
            $table->string('pangkat_kkm_temp', 30)->nullable(); // DIKURANGI DARI 50
            $table->string('golongan_kkm_temp', 30)->nullable(); // DIKURANGI DARI 50
            $table->string('nama_an_temp', 30)->nullable(); // DIKURANGI DARI 50
            $table->string('nip_an_temp', 20)->nullable(); // DIKURANGI DARI 25
            $table->string('jabatan_an_temp', 30)->nullable(); // DIKURANGI DARI 50
            $table->string('pangkat_an_temp', 30)->nullable(); // DIKURANGI DARI 50
            $table->string('golongan_an_temp', 30)->nullable(); // DIKURANGI DARI 50
            ...
            $table->string('nama_penyedia', 50)->nullable(); // DIKURANGI DARI 100
            $table->string('instansi_temp', 50)->nullable(); // DIKURANGI DARI 100
            $table->string('alamat_instansi_temp', 50)->nullable(); // DIKURANGI DARI 100
            $table->string('nomer_persetujuan', 50)->nullable(); // DIKURANGI DARI 100
            $table->date('tgl_persetujuan')->nullable();
            $table->integer('m_persetujuan_id')->nullable();
            $table->string('lokasi_temp', 50)->nullable(); // DIKURANGI DARI 100
